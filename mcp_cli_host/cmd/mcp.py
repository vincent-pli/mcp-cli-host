...
from mcp_cli_host.cmd.utils import COMMON_SEPERATOR, PREFIX_RESOURCE_TOOL, decode_uri_template
...
class Server:
    ...
    async def execute_tool(
        ...
        if tool_name.startswith(PREFIX_RESOURCE_TOOL):
            ...
            resource_uri = tool_name[len(PREFIX_RESOURCE_TOOL):]
            resource_uri = decode_uri_template(resource_uri)
